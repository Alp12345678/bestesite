...
export default function MekanlarPage() {
  const { activeCategoryKey, activeCategoryInfo, filteredData, loading, handleCategoryChange } =
    useCategoryData('mekanlar', MEKAN_KATEGORI_BILGILERI);
  ...
  return (
    <>
      <NextSeo
        ...
        canonical={`https://www.izmirdesen.com/mekanlar`}
        openGraph={{
          url: `https://www.izmirdesen.com/mekanlar`,
          title: `${activeCategoryInfo.title} | İzmirde Sen`,
          description: activeCategoryInfo.description,
          images: [
            {
        ...
        <div className="container mx-auto px-4">
          ...
          {!loading && filteredData.length === 0 && (
            <div className="text-center py-20 text-gray-500">
              <p className="text-xl">Bu kategoride henüz mekan bulunmuyor.</p>
            </div>
          )}
        </div>
      </main>
